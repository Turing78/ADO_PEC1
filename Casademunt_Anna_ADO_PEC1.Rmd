...
El codi R no es mostrarà en el cos del document, tot i que s'hi executen *chunks*. El codi complet es pot trobar al <https://github.com/Turing78/ADO_PEC1.git>, però aquest repositori és privat per donar compliment al codi étic de la UOC i evitar plagis. 
